    ...
    if (type === 'classic') {
        ...
        return (
            ...
            <motion.textarea
                ...
                transition={{ duration: 0.2 }}
                id={id}
                className='z-30 w-80 sm:w-96 md:w-[600px] lg:w-[400px] xl:w-[600px] h-36 sm:h-60 pl-4 pt-4 rounded-3xl shadow-neumorphism-inner bg-neumorphism-white text-black'
                placeholder={placeholder}
