...
const ContactImage = (): JSX.Element => {
    ...
    return (
        ...
        >
            ...
            <Image src='/images/avatar/paper-plane.png' width={370} height={390} className=' image absolute top-0 left-[10px] w-[370px] h-[390px] m-0 rounded-xl saturate-150' alt='paper-plane-img' />
