...
const TechStack = () => {
    ...
    return (
        <div className=' w-[120vw] md:w-[80vw]  h-[90vh] text-black rounded-lg bg-neumorphism-white shadow-neumorphism-image'>
            ...
            <div ref={scope} className='relative -top-6 md:top-10 w-full h-[90%] flex justify-stretch items-around flex-col md:justify-around md:items-center '>
                ...
                <div className='relative flex flex-col  items-start px-20 sm:px-24 -top-20 mb-12 md:mb-0'>
                ...
                <h2 className='pointer-events-none relative w-full -top-40 md:-top-36 left-5 md:left-20 text-transparent bg-clip-text opacity-10 bg-gradient-to-r from-purple to-transparent uppercase font-bold text-[90px] md:text-[170px] p-2 my-4'>Backend</h2>
